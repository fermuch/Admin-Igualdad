...
Requerimientos
--------------
Básicamente, no necesita mucho para funcionar.
...
* clonar repositorio a carpeta donde se quiera usar
''' cd /var/www/; git clone https://github.com/fermuch/Admin-Igualdad.git sistema
* dar permisos de escritura y lectura a la carpeta system/sqlite y sus archivos.
''' chmod -R 664 /var/www/sistema/system/sqlite
